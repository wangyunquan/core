...
public class QiNiuManagement {
    ...
    private String ACCESS_KEY ="TTOqKCYysH-JaYwoBCZ-5MogVCEiQLoQyqjz_0xp";

    private String SECRET_KEY= "xzo0MjvoEyK_Hz0zAu-KiHWDZJt3hBHVv66SqYoU";
    //要上传的空间

    private String bucketname="buswe";
    private Auth auth;
    ...
    public JSONObject upload(String filepath, String key) throws Exception {
        ...
        JSONObject object=new JSONObject(res.bodyString());
